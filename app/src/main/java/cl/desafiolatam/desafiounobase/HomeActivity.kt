...
//esta recomendación no aplica para todos los valores, pero ayuda con varios
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        save.setOnClickListener {
            //Agregar los pasos necesario para guardar los datoseste es Snack bar similar Toast
    ...
    private fun loadData() {
        userName = "UserName"
        val title = "BienvenidoEsta es la pantalla Principal, aquí $userName podrá ver todas sus preferencias"
